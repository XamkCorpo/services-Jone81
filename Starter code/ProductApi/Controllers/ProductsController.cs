...
public class ProductsController : ControllerBase
{
    ...
    public async Task<ActionResult<List<ProductResponse>>> SearchByName([FromQuery] string searchTerm)
    {
        Result<List<ProductResponse>> result = await _service.SearchByNameAsync(searchTerm);
